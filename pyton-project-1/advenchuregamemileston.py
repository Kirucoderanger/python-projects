...
#the game four levels on tow of scenarios
#the game is played by tow pepols and the enjoid it
...
if choise.lower() == "driving":
    ...
    if choise2.lower() == "race":
        ...
        if choise3.lower() == "schumacher":
            ...
            print("tyou enterd a wrong word, in put only words writen in capital letter")  
        ...
        choise3 = input("you had the brand new Ferrari which i gave you and you stoped by a gass station \n suddenly a fujitive came bay and  he showed you a gan forcing you to take him on drive way \n what you will do let him in ONBORD, quickliy DRIVE you car with out him: ")
        if choise3.lower() == "onbord":
            choise4 = input("the police starting chasing after you car what are you going to do \n SLOW the car, SPEED the car with maximum gear or strugle to UPRHEND the fujitive: ")
            if choise4.lower() == "slow":
                ...
                print ("you heat the police fance and your car wreak sent to jail with the fujitive")
            ...
            if choise4.lower() == "run":
                ...
                print ("eventualy the fire reache your car gas tanker and blow up your car wile you are inside")
